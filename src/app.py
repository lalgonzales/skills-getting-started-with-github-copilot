...
activities = {
    ...
    "Basketball Team": {
        "description": "Develop teamwork and basketball fundamentals through practice and games",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Train soccer skills and participate in friendly matches",
...
@app.get("/activities")
def get_activities():
    # returning a JSONResponse allows us to control headers
